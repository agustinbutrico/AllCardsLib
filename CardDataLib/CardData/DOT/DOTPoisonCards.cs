        ...
        internal static void Register()
        {
            Plugin.CardDisplayDataCollection.AllCards.AddRange(new List<CardDisplayData>
            {
                new CardDisplayData {
                    ...
                    Unlocks = new List<string> { "PoisonSlow", "DOTPoison2", "PoisonExtraDamage1" },
                    Unlocked = false,
                    Category = Category.DOT,
                    Subcategory = Subcategory.DOTPoison,
                ...
                new CardDisplayData {
                    ...
                    UnlockedByDefault = false,
                    Unlocks = new List<string> { "PoisonPop1", "PoisonExtraDamage2" },
                    Unlocked = false,
                    Category = Category.DOT,
                    Subcategory = Subcategory.DOTPoison,
                    AcquisitionType = AcquisitionType.StoreUnlocksInRun,
