        ...
        internal static void Register()
        {
            Plugin.CardDisplayDataCollection.AllCards.AddRange(new List<CardDisplayData>
            {
                ...
                new CardDisplayData {
                    ...
                    SpriteName = "Ballista",
                    UnlockName = "BalistaPHealth", // Typo in original game, should be BallistaPHealth
                ...
                new CardDisplayData {
                    ...
                    SpriteName = "Ballista",
                    UnlockName = "BalistaPArmor", // Typo in original game, should be BallistaPArmor
                    UnlockedByDefault = false,
                    Unlocks = new List<string> {  },
                    Unlocked = false,
                    Category = Category.Tower,
                ...
                new CardDisplayData {
                    ...
                    SpriteName = "Ballista",
                    UnlockName = "BalistaPShield", // Typo in original game, should be BallistaPShield
                    UnlockedByDefault = false,
                    Unlocks = new List<string> {  },
                    Unlocked = false,
                    Category = Category.Tower,
